...
const addOrder = async () => {
  ...
  let products = [
    {
      ...
      supplierTitle: "",
      brandTitle: "",
      productTitle: "Pray Often Mug",
      variantTitle: "",
      taxRate: 0.14975,
      taxRates: [
        { name: "GST", rate: 0.05, amount: 0.4 },
        { name: "QST", rate: 0.09975, amount: 0.798 },
      ],
      quantityOrdered: 1,
      quantityInvoiced: 1,
      quantityShipped: 1,
      ...
      product: {
        resource: {
          id: 39914775,
          url: "products/39914775",
          link: "http://api.shoplightspeed.com/us/products/39914775.json",
        },
      },
      variant: {
        resource: {
          id: 65592716,
          url: "variants/65592716",
          link: "http://api.shoplightspeed.com/us/variants/65592716.json",
        },
      },
    },
    {
  ...
  await axios({ method: "get", url: endpoint1 })
    .then((response) => {
  ...
  for (const product of products) {
    ...
    if (found) {
      ...
      await axios({ method: "get", url: `${endpoint2}/${categoryID}.json` })
        .then((response) => {
